...
class GloableTextFieldCell: UITableViewCell {
    ...
    func textFieldSetplaceholderText(placeholder:String?) {
...
class GloableTextViewCell: UITableViewCell {
    ...
    func textViewSetplaceholderText(placeholder:String?) {
